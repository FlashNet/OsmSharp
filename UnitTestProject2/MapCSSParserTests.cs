    ...
    public class MapCSSParserTests
    {
        ...
        public void TestColouredAddresses()
        {
            ...
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.coloured-addresses.mapcss");
        ...
        public void TestGisrussa()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.gisrussa.mapcss");
        ...
        public void TestHideNodes()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.Hide_nodes.mapcss");
        ...
        public void TestLanduses()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.landuses.mapcss");
        ...
        public void TestOamStyle()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.oam-style.mapcss");
        ...
        public void TestOpenstreetinfo()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.openstreetinfo.mapcss");
        ...
        //    // parses the MapCSS.
        //    AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
        //        "UnitTestProject2.Data.MapCSS.osmosnimki-hybrid.mapcss");
        ...
        public void TestPotlatch2()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.potlatch2.mapcss");
        ...
        public void Test_opencyclemap()
        {
            ...
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.opencyclemap.mapcss");
        ...
        //    // parses the MapCSS.
        //    AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
        //        "UnitTestProject2.Data.MapCSS.sport_styles.mapcss");
        ...
        public void TestTrivial()
        {
            // parses the MapCSS.
            AstParserRuleReturnScope<object, IToken> result = this.TestMapCSSParsing(
                "UnitTestProject2.Data.MapCSS.trivial.mapcss");
